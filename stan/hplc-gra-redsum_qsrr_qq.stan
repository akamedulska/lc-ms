...
if (mod2[z]==1) {
y_hat_Cond = chromgratrapz(steps2[z], 
    logkwx[analyte2[z],] +  dlogkT[analyte2[z]]*hplcparam2[z,11], 
    S1mx[analyte2[z],],  
    pKaw[analyte2[z],], 
    alpham[analyte2[z],],
    S2mHat,
...
real trHatCond = hplcparam2[z,3] + hplcparam2[z,4] + y_hat_Cond; 
trCond[z] = student_t_rng(3,trHatCond, sigma[analyte2[z]]);
}

// PRED
for(z in 1:nObs2){
if (mod2[z]==1) {
y_hat_Pred = chromgratrapz(steps2[z], 
       logkwxPred[analyte2[z],] +  dlogkTPred[analyte2[z]]*hplcparam2[z,11], 
       S1mxPred[analyte2[z],],  
       pKawPred[analyte2[z],], 
       alphamPred[analyte2[z],],
       S2mHat,
       apH,
       chargesA[analyte2[z],],
       chargesB[analyte2[z],],
...
y_hat_Pred = chromgratrapz(steps2[z], 
  ...
  real trHatPred = hplcparam2[z,3] + hplcparam2[z,4] + y_hat_Pred; 

  trPred[z] = student_t_rng(3, trHatPred, sigmaPred[analyte2[z]]);
}
}
